...
_interopRequireDefault(require("module$node_modules$$material_ui$core$esm$utils$useEventCallback")),_deprecatedPropType=_interopRequireDefault(require("module$node_modules$$material_ui$core$esm$utils$deprecatedPropType")),_withStyles=_interopRequireDefault(require("module$node_modules$$material_ui$core$esm$styles$withStyles")),_useIsFocusVisible2=_interopRequireDefault(require("module$node_modules$$material_ui$core$esm$utils$useIsFocusVisible")),_TouchRipple=_interopRequireDefault(require("module$node_modules$$material_ui$core$esm$ButtonBase$TouchRipple"));
...
disabled:{},focusVisible:{}};exports.styles=require;var ButtonBase=React.forwardRef(function(props,ref){function useRippleHandler(rippleAction,eventCallback){var skipRippleAction=2<arguments.length&&void 0!==arguments[2]?arguments[2]:disableTouchRipple;return(0,_useEventCallback.default)(function(event){eventCallback&&eventCallback(event);if(!skipRippleAction&&rippleRef.current)rippleRef.current[rippleAction](event);return!0})}var action=props.action,buttonRefProp=props.buttonRef,_props$centerRipple=
...
"reset","submit"]),global.default.string])};require=(0,_withStyles.default)(require,{name:"MuiButtonBase"})(ButtonBase);exports.default=require}
