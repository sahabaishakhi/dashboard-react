...
0<currentYear;currentYear=isCommonEra?currentYear:1-currentYear;50>=currentYear?twoDigitYear=twoDigitYear||100:(currentYear+=50,twoDigitYear=twoDigitYear+100*Math.floor(currentYear/100)-(twoDigitYear>=currentYear%100?100:0));return isCommonEra?twoDigitYear:1-twoDigitYear}Object.defineProperty(exports,"__esModule",{value:!0});exports.default=void 0;var _index=_interopRequireDefault(require("module$node_modules$date_fns$_lib$getUTCWeekYear$index")),_index2=_interopRequireDefault(require("module$node_modules$date_fns$_lib$setUTCDay$index")),
_index3=_interopRequireDefault(require("module$node_modules$date_fns$_lib$setUTCISODay$index")),_index4=_interopRequireDefault(require("module$node_modules$date_fns$_lib$setUTCISOWeek$index")),_index5=_interopRequireDefault(require("module$node_modules$date_fns$_lib$setUTCWeek$index")),_index6=_interopRequireDefault(require("module$node_modules$date_fns$_lib$startOfUTCISOWeek$index")),_index7=_interopRequireDefault(require("module$node_modules$date_fns$_lib$startOfUTCWeek$index")),numericPatterns=
{month:/^(1[0-2]|0?\d)/,date:/^(3[0-1]|[0-2]?\d)/,dayOfYear:/^(36[0-6]|3[0-5]\d|[0-2]?\d?\d)/,week:/^(5[0-3]|[0-4]?\d)/,hour23h:/^(2[0-3]|[0-1]?\d)/,hour24h:/^(2[0-4]|[0-1]?\d)/,hour11h:/^(1[0-1]|0?\d)/,hour12h:/^(1[0-2]|0?\d)/,minute:/^[0-5]?\d/,second:/^[0-5]?\d/,singleDigit:/^\d/,twoDigits:/^\d{1,2}/,threeDigits:/^\d{1,3}/,fourDigits:/^\d{1,4}/,anyDigitsSigned:/^-?\d+/,singleDigitSigned:/^-?\d/,twoDigitsSigned:/^-?\d{1,2}/,threeDigitsSigned:/^-?\d{1,3}/,fourDigitsSigned:/^-?\d{1,4}/},JSCompiler_object_inline_basicOptionalMinutes_5933=
/^([+-])(\d{2})(\d{2})?|Z/,JSCompiler_object_inline_basic_5934=/^([+-])(\d{2})(\d{2})|Z/,JSCompiler_object_inline_basicOptionalSeconds_5935=/^([+-])(\d{2})(\d{2})((\d{2}))?|Z/,JSCompiler_object_inline_extended_5936=/^([+-])(\d{2}):(\d{2})|Z/,JSCompiler_object_inline_extendedOptionalSeconds_5937=/^([+-])(\d{2}):(\d{2})(:(\d{2}))?|Z/,DAYS_IN_MONTH=[31,28,31,30,31,30,31,31,30,31,30,31],DAYS_IN_MONTH_LEAP_YEAR=[31,29,31,30,31,30,31,31,30,31,30,31];exports.default={G:{priority:140,parse:function(string,
token,match,_options){switch(token){case "G":case "GG":case "GGG":return match.era(string,{width:"abbreviated"})||match.era(string,{width:"narrow"});case "GGGGG":return match.era(string,{width:"narrow"});default:return match.era(string,{width:"wide"})||match.era(string,{width:"abbreviated"})||match.era(string,{width:"narrow"})}},set:function(date,flags,value,_options){flags.era=value;date.setUTCFullYear(value,0,1);date.setUTCHours(0,0,0,0);return date},incompatibleTokens:["R","u","t","T"]},y:{priority:130,
parse:function(string,token,match,_options){_options=function(year){return{year,isTwoDigitYear:"yy"===token}};switch(token){case "y":return parseNDigits(4,string,_options);case "yo":return match.ordinalNumber(string,{unit:"year",valueCallback:_options});default:return parseNDigits(token.length,string,_options)}},validate:function(_date,value,_options){return value.isTwoDigitYear||0<value.year},set:function(date,flags,value,_options){_options=date.getUTCFullYear();if(value.isTwoDigitYear)return flags=
...
"T"]},X:{priority:10,parse:function(string,token,_match,_options){switch(token){case "X":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalMinutes_5933,string);case "XX":return parseTimezonePattern(JSCompiler_object_inline_basic_5934,string);case "XXXX":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalSeconds_5935,string);case "XXXXX":return parseTimezonePattern(JSCompiler_object_inline_extendedOptionalSeconds_5937,string);default:return parseTimezonePattern(JSCompiler_object_inline_extended_5936,
string)}},set:function(date,flags,value,_options){return flags.timestampIsSet?date:new Date(date.getTime()-value)},incompatibleTokens:["t","T","x"]},x:{priority:10,parse:function(string,token,_match,_options){switch(token){case "x":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalMinutes_5933,string);case "xx":return parseTimezonePattern(JSCompiler_object_inline_basic_5934,string);case "xxxx":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalSeconds_5935,string);case "xxxxx":return parseTimezonePattern(JSCompiler_object_inline_extendedOptionalSeconds_5937,
...
_token,_match,_options){return parseNumericPattern(numericPatterns.anyDigitsSigned,string,void 0)},set:function(_date,_flags,value,_options){return[new Date(value),{timestampIsSet:!0}]},incompatibleTokens:"*"}};module.exports=exports.default}
//# sourceMappingURL=module$node_modules$date_fns$parse$_lib$parsers$index.js.map
