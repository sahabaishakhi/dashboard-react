...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26775 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26775(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26776 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26776(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26777 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26777(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26778 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26778(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26779 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26779(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26785 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26785(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26786 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26786(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26793 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26793(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26794 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26794(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26795 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26795(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26796 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26796(b);
}
});
