...
JSCompiler_object_inline_basicOptionalMinutes_5920=/^([+-])(\d{2})(\d{2})?|Z/,JSCompiler_object_inline_basic_5921=/^([+-])(\d{2})(\d{2})|Z/,JSCompiler_object_inline_basicOptionalSeconds_5922=/^([+-])(\d{2})(\d{2})((\d{2}))?|Z/,JSCompiler_object_inline_extended_5923=/^([+-])(\d{2}):(\d{2})|Z/,JSCompiler_object_inline_extendedOptionalSeconds_5924=/^([+-])(\d{2}):(\d{2})(:(\d{2}))?|Z/,DAYS_IN_MONTH=[31,28,31,30,31,30,31,31,30,31,30,31],DAYS_IN_MONTH_LEAP_YEAR=[31,29,31,30,31,30,31,31,30,31,30,31];exports.default=
...
"T"]},X:{priority:10,parse:function(string,token,_match,_options){switch(token){case "X":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalMinutes_5920,string);case "XX":return parseTimezonePattern(JSCompiler_object_inline_basic_5921,string);case "XXXX":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalSeconds_5922,string);case "XXXXX":return parseTimezonePattern(JSCompiler_object_inline_extendedOptionalSeconds_5924,string);default:return parseTimezonePattern(JSCompiler_object_inline_extended_5923,
string)}},set:function(date,flags,value,_options){return flags.timestampIsSet?date:new Date(date.getTime()-value)},incompatibleTokens:["t","T","x"]},x:{priority:10,parse:function(string,token,_match,_options){switch(token){case "x":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalMinutes_5920,string);case "xx":return parseTimezonePattern(JSCompiler_object_inline_basic_5921,string);case "xxxx":return parseTimezonePattern(JSCompiler_object_inline_basicOptionalSeconds_5922,string);case "xxxxx":return parseTimezonePattern(JSCompiler_object_inline_extendedOptionalSeconds_5924,
string);default:return parseTimezonePattern(JSCompiler_object_inline_extended_5923,string)}},set:function(date,flags,value,_options){return flags.timestampIsSet?date:new Date(date.getTime()-value)},incompatibleTokens:["t","T","X"]},t:{priority:40,parse:function(string,_token,_match,_options){return parseNumericPattern(numericPatterns.anyDigitsSigned,string,void 0)},set:function(_date,_flags,value,_options){return[new Date(1E3*value),{timestampIsSet:!0}]},incompatibleTokens:"*"},T:{priority:20,parse:function(string,
_token,_match,_options){return parseNumericPattern(numericPatterns.anyDigitsSigned,string,void 0)},set:function(_date,_flags,value,_options){return[new Date(value),{timestampIsSet:!0}]},incompatibleTokens:"*"}}}
//# sourceMappingURL=module$node_modules$date_fns$esm$parse$_lib$parsers$index.js.map
