...
var i_29535 = (self__.level + (1));
while(true){
if((i_29535 <= (new_level + (1)))){
(update[i_29535] = self__.header);

var G__29537 = (i_29535 + (1));
i_29535 = G__29537;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29616 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29616[i]));
} else {
x__$2.forward.push((((i < links_29616.length))?(links_29616[i]):null));
}

if((i < links_29616.length)){
(links_29616[i] = x__$2);
} else {
links_29616.push(x__$2);
}
...
var i_29619 = (0);
while(true){
if((i_29619 <= self__.level)){
var links_29620 = (update[i_29619]).forward;
if((x__$1 === (((i_29619 < links_29620.length))?(links_29620[i_29619]):null))){
(links_29620[i_29619] = (x__$1.forward[i_29619]));

var G__29621 = (i_29619 + (1));
i_29619 = G__29621;
continue;
} else {
var G__29622 = (i_29619 + (1));
i_29619 = G__29622;
continue;
}
} else {
...
var G__29627 = nx;
var G__29628 = (level__$1 - (1));
x = G__29627;
level__$1 = G__29628;
continue;
} else {
var G__29629 = x;
var G__29630 = (level__$1 - (1));
x = G__29629;
level__$1 = G__29630;
continue;
}
