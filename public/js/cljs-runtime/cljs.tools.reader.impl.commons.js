...
var G__26726 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26726;
continue;
} else {
return ch;
...
var vec__26701 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26701,(0),null);
return (match === s);
});
...
args__4870__auto__.push((arguments[i__4865__auto___26733]));
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26713){
...
return (function() { 
var G__26737__delegate = function (rdr,_){
...
var G__26737 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__26739__i = 0, G__26739__a = new Array(arguments.length -  1);
while (G__26739__i < G__26739__a.length) {G__26739__a[G__26739__i] = arguments[G__26739__i + 1]; ++G__26739__i;}
  _ = new cljs.core.IndexedSeq(G__26739__a,0,null);
} 
return G__26737__delegate.call(this,rdr,_);};
G__26737.cljs$lang$maxFixedArity = 1;
G__26737.cljs$lang$applyTo = (function (arglist__26740){
var rdr = cljs.core.first(arglist__26740);
var _ = cljs.core.rest(arglist__26740);
return G__26737__delegate(rdr,_);
});
