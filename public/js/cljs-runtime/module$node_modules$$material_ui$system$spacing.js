...
spacingKeys.indexOf(prop))return null;var cssProperties=getCssProperties(prop);cssProperties=getStyleFromPropValue(cssProperties,transformer);return(0,_breakpoints.handleBreakpoints)(props,props[prop],cssProperties)}).reduce(_merge.default,{})}global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports.createUnarySpacing=createUnarySpacing;exports.default=void 0;var _slicedToArray2=global(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),
_responsivePropType=global(require("module$node_modules$$material_ui$system$responsivePropType")),_breakpoints=require("module$node_modules$$material_ui$system$breakpoints"),_merge=global(require("module$node_modules$$material_ui$system$merge")),properties={m:"margin",p:"padding"},directions={t:"Top",r:"Right",b:"Bottom",l:"Left",x:["Left","Right"],y:["Top","Bottom"]},aliases={marginX:"mx",marginY:"my",paddingX:"px",paddingY:"py"},getCssProperties=(0,global(require("module$node_modules$$material_ui$system$memoize")).default)(function(prop){if(2<
prop.length)if(aliases[prop])prop=aliases[prop];else return[prop];prop=prop.split("");prop=(0,_slicedToArray2.default)(prop,2);var property=properties[prop[0]];prop=directions[prop[1]]||"";return Array.isArray(prop)?prop.map(function(dir){return property+dir}):[property+prop]}),spacingKeys="m mt mr mb ml mx my p pt pr pb pl px py margin marginTop marginRight marginBottom marginLeft marginX marginY padding paddingTop paddingRight paddingBottom paddingLeft paddingX paddingY".split(" ");spacing.propTypes=
spacingKeys.reduce(function(obj,key){obj[key]=_responsivePropType.default;return obj},{});spacing.filterProps=spacingKeys;exports.default=spacing}
