...
function findNativeHandler(_ref){var start=_ref.start,current=_ref.current,anchor=_ref.anchor,JSCompiler_object_inline_scrollPosition_5946={x:"scrollLeft",y:"scrollTop"},JSCompiler_object_inline_scrollLength_5947={x:"scrollWidth",y:"scrollHeight"},JSCompiler_object_inline_clientLength_5948={x:"clientWidth",y:"clientHeight"};return _ref.domTreeShapes.some(function(shape){var goingForward=current>=start;if("top"===anchor||"left"===anchor)goingForward=!goingForward;var axis="left"===anchor||"right"===
anchor?"x":"y",scrollPosition=shape[JSCompiler_object_inline_scrollPosition_5946[axis]];axis=scrollPosition+shape[JSCompiler_object_inline_clientLength_5948[axis]]<shape[JSCompiler_object_inline_scrollLength_5947[axis]];return goingForward&&axis||!goingForward&&0<scrollPosition?shape:null})}var _interopRequireWildcard=require("module$node_modules$$babel$runtime$helpers$interopRequireWildcard"),_interopRequireDefault=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,
...
setMaybeSwiping(!1)},[open]);_React$useState=React.useCallback(function(instance){backdropRef.current=ReactDOM.findDOMNode(instance)},[]);return React.createElement(React.Fragment,null,React.createElement(_Drawer.default,(0,_extends2.default)({open:"temporary"===variant&&_props$swipeAreaWidth?!0:open,variant,ModalProps:(0,_extends2.default)({BackdropProps:(0,_extends2.default)({},_props$anchor,{ref:_React$useState})},_props$ModalProps),PaperProps:(0,_extends2.default)({},_props$PaperProps,{style:(0,_extends2.default)({pointerEvents:"temporary"!==
variant||open?"":"none"},_props$PaperProps.style),ref:paperRef}),anchor,transitionDuration:calculatedDurationRef.current||transitionDuration,onClose,ref},inProps)),!disableSwipeToOpen&&"temporary"===variant&&React.createElement(_NoSsr.default,null,React.createElement(_SwipeArea.default,(0,_extends2.default)({anchor,ref:swipeAreaRef,width:swipeAreaWidth},SwipeAreaProps))))});require.propTypes={anchor:global.default.oneOf(["left","top","right","bottom"]),children:global.default.node,disableBackdropTransition:global.default.bool,
disableDiscovery:global.default.bool,disableSwipeToOpen:global.default.bool,hideBackdrop:global.default.bool,hysteresis:global.default.number,minFlingVelocity:global.default.number,ModalProps:global.default.shape({BackdropProps:global.default.shape({component:module.elementTypeAcceptingRef})}),onClose:global.default.func.isRequired,onOpen:global.default.func.isRequired,open:global.default.bool.isRequired,PaperProps:global.default.shape({component:module.elementTypeAcceptingRef,style:global.default.object}),
SwipeAreaProps:global.default.object,swipeAreaWidth:global.default.number,transitionDuration:global.default.oneOfType([global.default.number,global.default.shape({enter:global.default.number,exit:global.default.number})]),variant:global.default.oneOf(["permanent","persistent","temporary"])};exports.default=require}
